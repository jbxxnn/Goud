                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent className="bg-white/90 backdrop-blur-xl border-0 rounded-[2rem] shadow-2xl max-w-sm" style={{ borderRadius: '1rem' }}>
                                    <AlertDialogHeader>
                                        <AlertDialogTitle className="text-xl font-bold text-gray-900">Opnieuw beginnen?</AlertDialogTitle>
                                        <AlertDialogDescription className="text-gray-600">
                                            Weet u zeker dat u opnieuw wilt beginnen? Alle ingevulde gegevens worden gewist.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
                                        <AlertDialogCancel className="rounded-xl border-0 bg-gray-100/50 hover:bg-gray-200/50 text-gray-700">Terug</AlertDialogCancel>
                                        <AlertDialogAction
                ...
                <CardContent className="p-8 pt-0 space-y-4">
                    ...
                    {(loadingServices || serviceId) ? (
                        <div className="group relative overflow-hidden rounded-2xl bg-gray-50 hover:bg-gray-50/80 transition-colors duration-300">
                            ...
                            <div className="p-5 pl-7">
                                <p className="text-xs font-bold text-gray-800 tracking-wider mb-2">Service</p>
                                {loadingServices ? (
                                    <div>
                    ...
                    {(loadingLocations || locationId) ? (
                        <div className="group relative overflow-hidden rounded-2xl bg-gray-50 hover:bg-gray-50/80 transition-colors duration-300">
                            <div className="absolute top-0 left-0 w-1 h-full bg-primary/20 group-hover:bg-primary transition-colors duration-300" />
                            <div className="p-5 pl-7">
                                <p className="text-xs font-bold text-gray-800 tracking-wider mb-2">Location</p>
                                {loadingLocations ? (
                    ...
                    {(loadingHeatmap || date) ? (
                        <div className="group relative overflow-hidden rounded-2xl bg-gray-50 hover:bg-gray-50/80 transition-colors duration-300">
                            <div className="absolute top-0 left-0 w-1 h-full bg-primary/20 group-hover:bg-primary transition-colors duration-300" />
                            <div className="p-5 pl-7">
                                <p className="text-xs font-bold text-gray-800 tracking-wider mb-2">Date & Time</p>
                                {loadingHeatmap ? (
                    ...
                    {(loadingServices || otherSelections.length > 0) ? (
                        <div className="group relative overflow-hidden rounded-2xl bg-gray-50 hover:bg-gray-50/80 transition-colors duration-300">
                            <div className="absolute top-0 left-0 w-1 h-full bg-primary/20 group-hover:bg-primary transition-colors duration-300" />
                            <div className="p-5 pl-7">
                                <p className="text-xs font-bold text-gray-800 tracking-wider mb-2">Others</p>
                                {loadingServices ? (
                                    <div className="h-6 w-3/4 bg-gray-200/50 rounded animate-pulse" />
                                ) : (
                                    <div className="animate-in fade-in zoom-in-95 duration-500">
                    ...
                    <div className="pt-4 mt-2 border-t border-gray-100">
                        <div className="flex items-center justify-between">
                            <span className="text-xs font-bold text-gray-800">Total Due</span>

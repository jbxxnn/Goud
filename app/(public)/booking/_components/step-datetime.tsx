...
export function StepDateTime() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-lg font-bold text-gray-900">Location, Date & Time</h2>
                <p className="text-sm text-gray-600">Choose your location, date and time slot.</p>
            </div>
                ...
                <Select value={locationId} onValueChange={setLocationId}>
                    <SelectTrigger id="location-select-step2" className="w-full">
                        {loadingLocations ? (
                            ...
                            <SelectValue placeholder="Choose location" className="text-lg">

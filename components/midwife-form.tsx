        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <Input
                ...
                {...register('practice_name', {
                  maxLength: { value: 255, message: 'Practice name must be less than 255 characters' },
                })}
                placeholder="Enter practice name (optional)"
              />
            ...
            <div>
              ...
              <Input
                id="phone"
                {...register('phone', {
                  maxLength: { value: 32, message: 'Phone must be less than 32 characters' },
                })}
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Inactive midwives will not appear in booking forms
              </p>
            </div>
          </div>
        </div>

  ...
  ({ className, dateInputClassName, segmentClassName, disabled, "data-invalid": dataInvalid, ...props }, ref) => {
    return (
      ...
      >
        <DateInput
          className={cn(
            "peer inline-flex h-9 w-auto items-center overflow-hidden whitespace-nowrap rounded-md border bg-background px-1 py-2 text-sm shadow-sm transition-all duration-200",
        ...
        >
          {segment => (
            <DateSegment
              segment={segment}
              className={cn(
                "inline rounded px-1 min-w-[5px] tabular-nums caret-transparent outline outline-0",
                "focus:bg-primary-foreground focus:text-secondary-foreground data-[focused]:bg-primary-foreground data-[focused]:text-secondary-foreground",

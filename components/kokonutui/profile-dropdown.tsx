            ...
            <DropdownMenu>
                <div className="group relative">
                    <DropdownMenuTrigger asChild>
                        <button
                            type="button"
                            className="flex items-center gap-16 p-0 rounded-full bg-white dark:bg-zinc-900 border border-secondary dark:border-zinc-800/60 hover:border-zinc-300 dark:hover:border-zinc-700 hover:bg-zinc-50/80 dark:hover:bg-zinc-800/40 hover:shadow-sm transition-all duration-200 focus:outline-none"
                            style={{ borderRadius: '10rem' }}
                        >
                            <div className="relative">
                                <div className="w-8 h-8 rounded-full bg-secondary p-0.5">
                    ...
                    <DropdownMenuContent
                        align="end"
                        sideOffset={4}
                        className="w-64 p-2 bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800/60 rounded-2xl shadow-xl shadow-zinc-900/5 dark:shadow-zinc-950/20 z-[9999] !z-[9999]

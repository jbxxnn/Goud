...
export function DayCell({ cell, events, eventPositions, onShiftDeleted, onShiftUpdated, onEventClick, hideAddButton }: IProps) {
            ...
            <div key={eventKey} className="lg:flex-1">
              {event && (
                <>
                  ...
                  <MonthEventBadge className="hidden lg:flex" event={event} cellDate={startOfDay(date)} onShiftDeleted={onShiftDeleted} onShiftUpdated={onShiftUpdated} onEventClick={onEventClick} isReadOnly={hideAddButton} />
                </>
              )}
            </div>
          );
